const createContacts = () => {
  ...
  nameLabel.innerHTML =
    "Name and Surname <input type='text' name ='name' required>";
  ...
  peopleLabel.innerHTML =
    "Nr. Persons <input type='number' min='1' name ='people'>";
  ...
  noteLabel.innerHTML =
    "Note <textarea id='comments' placeholder='Leave a comment here'</textarea>";
